...
/// <summary>
/// Tool function definition for request schemas.
/// Used when defining available tools in ChatRequest, not for tool call responses.
/// </summary>
public sealed record OllamaToolDefinition
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OllamaToolDefinition"/> class.
    /// </summary>
