...
- **Canonical Task Title:** Task 036.a: deploy tool schema
...
**Update:** Deploy tool schema MUST include optional `provenance` fields (repo_sha, run_id, worktree_id) and MUST support `audit_event_id` outputs.
