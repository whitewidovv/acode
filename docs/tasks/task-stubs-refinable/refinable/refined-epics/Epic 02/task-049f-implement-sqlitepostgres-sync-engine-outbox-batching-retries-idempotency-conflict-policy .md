...
# Task 049.f: Implement SQLite→Postgres sync engine (outbox, batching, retries, idempotency, conflict policy)

**Priority:** 49 / 49  
**Tier:** S  
**Complexity:** 13 (Fibonacci points)  
**Phase:** Phase 2 - CLI + Orchestration Core  
**Dependencies:** Task 049.a, Task 050, Task 039  

---

## Description (EXPAND THIS)

Implement reliable sync between SQLite workspace and Postgres using outbox/inbox, idempotency keys, retries, batching, and conflict policy.
