...
Implement the shared workspace database foundation: SQLite local DB + migrations + Postgres connector configuration used by run state, queue persistence, and chat history.
