...
- **Epic:** EPIC 10 — Reliability, Resumability, Deterministic Runs
- **Canonical Task Title:** Task 041.c: needs-human transition rules
- **Sibling Subtasks (if applicable):**
  - Task 041.a: categorize failures
  - Task 041.b: capped retries
  - Task 041.c: needs-human transition rules
