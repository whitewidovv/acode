...
- ⏳ task-007a-json-schema-definitions-for-all-core-tools -- **IN PROGRESS**
...
- [ ] task-007c-truncation-artifact-attachment-rules -- Read instructions at top of this file and follow them, including reading the mentioned files, before starting expansion 
- [ ] task-007d-tool-call-parsing-retry-on-invalid-json -- Read instructions at top of this file and follow them, including reading the mentioned files, before starting expansion 
